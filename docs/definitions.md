...
- **Tier 3, Slow Expanse.** Tens of thousands off Earth, including at least one site beyond the Earth-Moon system (asteroid belt, outer moon, or a habitat out there). Transit times in months. A resource economy where something mined or made off Earth is sold at a profit. Transit fast enough that people go out there to work.
...
AMENDED 2026-09-25 (the function-over-route pass, docs/proposal-function-over-route-2026-09-25.md, candidate 6; ruled by John). Tier 3's propulsion clause read "Nuclear propulsion in routine use" from 2026-09-08. What a Slow Expanse needs is transit fast enough that people go out there to work, and nuclear propulsion is one way to get it; high-power solar-electric propulsion is another. The clause now names the function, and the tier's test is a step that counts any propulsion: three missions in one year reaching the asteroid belt within twelve months of leaving Earth. Nuclear propulsion stays in the tree as one route to it.
...
- 2026-09-25. Training goals aligned to the window (docs/proposal-training-goals-and-window-2026-09-25.md): three goal horizons (gate, six-year fork, window) entered in TimeAssembler; the window paragraph may carry an age-graded percent as well as a percentile, from a yearly counted-track 5K under World Masters Athletics age grading and a periodic lab VO2max against Cooper Institute norms, entered at the annual review (baseline: the 2026-09-15 counted-track 5K; first annual point run during exodus, week of 2026-12-21, since the pipeline allows no tests after 2027-01-04); access-branch training links deferred to the May 2027 review. Proposed by Claude, accepted as recommended by John.
- 2026-09-25. The function-over-route pass (docs/proposal-function-over-route-2026-09-25.md; landing recorded in docs/handoff-function-over-route-2026-09-25.md) counted as the review that methodology.md requires before a tier's requirements or definition change, on the methodology-pass precedent (ruled by John; proposed by Claude). Candidate 6: Tier 3's definition changed from "Nuclear propulsion in routine use" to "Transit fast enough that people go out there to work", and its requirement from routine nuclear propulsion to a step that counts any propulsion (three missions in one year reaching the asteroid belt within twelve months of leaving Earth), with nuclear propulsion and high-power solar-electric propulsion as its routes. The rule itself (a link names the function a child needs, not one route to it) went into methodology.md and node-schema.md the same day. Proposed by Claude, approved by John in full.
